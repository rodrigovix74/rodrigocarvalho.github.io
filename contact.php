...
<head>
    <meta charset="utf-8" />
    <title>Rodrigo Carvalho dos Santos</title>
    ...
    <meta name="description" content="Portifólio dos projetos entregues por Rodrigo Carvalho dos Santos" />
    <!-- Styles -->
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/rodrigo.jpg" alt="Rodrigo Carvalho dos Santos">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Rodrigo Carvalho dos Santos</h4>
                        <div class="status">Desenvolvedor WEB</div>
                        <ul class="header__social">
                            <li>
                                <a href="https://www.linkedin.com/in/rodrigo-carvalho-dos-santos-484b0255/">
                                    <i class="font-icon icon-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/rodrigovix74">
                                    <i class="font-icon icon-github"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/rodrigovix74">
                                    <i class="font-icon icon-youtube"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/rodrigovix74">
